...
function displayVINGrid($segment, $group = null, $page_hold = false) {
    global $vin_schema;
    ...
    echo '<table class="vin_table">';

    foreach($vin_schema[$segment] AS $element) {
        $sub_out = null;

        if(!empty($element['image'])) {
            if($element['group'] !== $prev_group) {
                for($i = $col_count; $i < $max_cols; $i++) {
                    echo "<td></td>";
                }

                echo "</tbody><tr><th colspan='$max_cols'>{$element['group']}</th></tr><tbody>";

                $prev_group = $element['group'];
                $col_count = 0;
            }

            $group = (!empty($group)) ? $group : $segment;

            if(!empty($element['subitems'])) {
                $i = 1;

                $subitems = json_decode($element['subitems'], TRUE);
                $subitem_count = count($subitems);

                $pct = (100 / $subitem_count);

                $sub_out = "<div class='subitems'>";
                ...
                foreach($subitems as $key => $item) {
                    ...
                    $sub_out .= "<div class='item active_vin_element {$group}_sub' data-parent='$group' data-group='{$group}_sub' data-pagehold='$page_hold' style='width:calc({$pct}% - {$padding}px);$no_border'>($key)<br />$item</div>";

                    $i++;
                }

                $sub_out .= "<div class='clearfix'></div></div>";

                $main_active = null;
                $style_addl = 'style="cursor:default;"';
            } else {
                $main_active = 'active_vin_element';
                $style_addl = null;
            }

            if($col_count < $max_cols) {
                echo "<td><div class='$main_active $group' data-group='$group' data-pagehold='$page_hold' id='{$element['id']}' $style_addl><div>{$element['key']}<br />{$element['value']}<br /><img src='/assets/images/vin/{$element['image']}' /></div></div>$sub_out</td>";
            } else {
                echo "</tr><tr>";
                echo "<td><div class='$main_active $group' data-group='$group' data-pagehold='$page_hold' id='{$element['id']}'  $style_addl><div>{$element['key']}<br />{$element['value']}<br /><img src='/assets/images/vin/{$element['image']}' /></div></div>$sub_out</td>";
            ...
            if($col_count < $max_cols) {
                echo "<td><div class='$main_active $group' data-group='$group' data-pagehold='$page_hold' id='{$element['id']}' $style_addl><div>{$element['key']}<br />{$element['value']}</div></div>$sub_out</td>";
            } else {
                echo "</tr><tr>";
                echo "<td><div class='$main_active $group' data-group='$group' data-pagehold='$page_hold' id='{$element['id']}' $style_addl><div>{$element['key']}<br />{$element['value']}</div></div>$sub_out</td>";
...
?>
                            ...
                            <div class="card-box">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="build-a-vin">
                                            <h3>Species</h3>
                                            <section><?php displayVINGrid('species_grade'); ?></section>

                                            <h3>Construction Method</h3>
                                            <section><?php displayVINGrid('construction_method'); ?></section>

                                            <h3>Door Design</h3>
                                            <section><?php displayVINGrid('door_design'); ?></section>

                                            <h3>Panel Raise:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Door</h3>
                                            <section><?php displayVINGrid('panel_raise', 'pr_door'); ?></section>

                                            <h3>Panel Raise:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Short Drawer</h3>
                                            <section><?php displayVINGrid('panel_raise', 'pr_short_drawer'); ?></section>

                                            <h3>Panel Raise:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tall Drawer</h3>
                                            <section><?php displayVINGrid('panel_raise', 'pr_tall_drawer'); ?></section>

                                            <h3>Edge Profile</h3>
                                            <section><?php displayVINGrid('edge_profile'); ?></section>

                                            <h3>Framing Bead</h3>
                                            <section><?php displayVINGrid('framing_bead'); ?></section>

                                            <h3>Framing Options</h3>
                                            <section><?php displayVINGrid('framing_options'); ?></section>

                                            <h3>Panel Options</h3>
                                            <section><?php displayVINGrid('panel_options'); ?></section>

                                            <h3>Hand Pull</h3>
                                            <section><?php displayVINGrid('hand_pull'); ?></section>

                                            <h3>Stile/Rail Width</h3>
                                            <section><?php displayVINGrid('style_rail_width'); ?></section>

                                            <h3>Door/Drawer:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Finish</h3>
                                            <section><?php displayVINGrid('finish_code', 'dd_finish'); ?></section>

                                            <h3>Door/Drawer:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sheen</h3>
                                            <section><?php displayVINGrid('sheen', 'dd_sheen'); ?></section>

                                            <h3>Door/Drawer:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Glaze</h3>
                                            <section><?php displayVINGrid('glaze_technique', 'dd_glaze_tech', 'true'); displayVINGrid('glaze', 'dd_glaze'); ?></section>

                                            <h3>Door/Drawer:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Distressing</h3>
                                            <section><?php displayVINGrid('distress_level',null, 'true'); displayVINGrid('worn_edges', null, 'true'); displayVINGrid('antiquing'); ?></section>

                                            <h3>Carcass:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Exterior Species</h3>
                                            <section><?php displayVINGrid('carcass_species', 'carcass_ext_species'); ?></section>

                                            <h3>Carcass:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Exterior Finish</h3>
                                            <section><?php displayVINGrid('finish_code', 'carcass_ext_finish'); ?></section>

                                            <h3>Carcass:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Exterior Glaze</h3>
                                            <section><?php displayVINGrid('glaze', 'carcass_ext_glaze_color', 'true'); displayVINGrid('glaze_technique', 'carcass_ext_glaze_tech'); ?></section>

                                            <h3>Carcass:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Interior Species</h3>
                                            <section><?php displayVINGrid('carcass_species', 'carcass_int_species'); ?></section>

                                            <h3>Carcass:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Interior Finish</h3>
                                            <section><?php displayVINGrid('finish_code', 'carcass_int_finish'); ?></section>

                                            <h3>Carcass:<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Interior Glaze</h3>
                                            <section><?php displayVINGrid('glaze', 'carcass_int_glaze_color', 'true'); displayVINGrid('glaze_technique', 'carcass_int_glaze_tech'); ?></section>

                                            <h3>Drawer Boxes</h3>
                                            <section><?php displayVINGrid('drawer_boxes'); ?></section>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        // -- Navigation --
            ...
            .on("click", ".active_vin_element", function() {
                var clicked = $(this);
                var group = clicked.data("group");
                var parent = clicked.data("parent");
                var parent_group = clicked.parent().parent().find('div').first().data('group');


                $("." + group).removeClass("active").children('div').removeClass("active");
                $('.subitems').find('.' + group).removeClass("active");

                if(parent !== undefined) {
                    $("." + parent).removeClass("active").children('div').removeClass("active");
                    $(this).parent().parent().find('.' + parent_group).first().addClass('active');
                }

                clicked.addClass('active');

                if($(this).data("pagehold") !== true) {
                    wizard.steps("next");
                }
            })
