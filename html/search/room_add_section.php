    ...
    <form id="room_edit_<?php echo $room['id']; ?>">
        <div class="row">
            <div class="col-md-1 sticky">
                ...
                echo ($bouncer->validate('add_attachment')) ? "<br /><br /><a id='add_attachment' class='btn btn-primary-outline btn-block waves-effect waves-light w-xs'>Add Attachments</a><br />" : null;
