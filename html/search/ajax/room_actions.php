...
switch($_REQUEST['action']) {
  case 'add_new_room':
    ...
    if($bracket_qry = $dbconn->query("SELECT * FROM default_bracket WHERE product_type = '$product_type' AND room_type = '$room_type'")) {
      ...
      $so_qry = $dbconn->query("SELECT * FROM sales_order WHERE so_num = ''");
      ...
      individual_bracket_buildout) VALUES ('$room_letter', '$room_name', '$iteration', '$product_type', '$order_status', '$days_to_ship', '$room_type', '{$bracket['sales_bracket']}', 
      '{$bracket['sales_published']}', '{$bracket['preproduction_bracket']}', '{$bracket['preproduction_published']}', '{$bracket['sample_bracket']}', 
      '{$bracket['sample_published']}', '{$bracket['doordrawer_bracket']}', '{$bracket['doordrawer_published']}', '{$bracket['custom_bracket']}', '{$bracket['custom_published']}', 
      '{$bracket['main_bracket']}', '{$bracket['main_published']}', '{$bracket['shipping_bracket']}', '{$bracket['shipping_published']}', '{$bracket['install_bracket']}', 
      '{$bracket['install_bracket_published']}', '{$bracket['pick_materials_bracket']}', '{$bracket['pick_materials_published']}', '{$bracket['edgebanding_bracket']}', 
      '{$bracket['edgebanding_published']}', '{$bracket['bracket']}')")) {
