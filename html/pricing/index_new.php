...
HEREDOC;
    ...
    pricingFunction.productionLockInit();
    pricingFunction.init();
    pricingFunction.saveInit();
    pricingFunction.copyroomInit();
    pricingFunction.applianceInit();
    pricingFunction.recalcInit();
    pricingFunction.downloadInit();
    pricingFunction.calShipDateInit();
    pricingFunction.editShipDateInit();
    pricingFunction.editShipCostInit();
    pricingFunction.editCatalogLockInit();
    pricingFunction.itemNoteInit();
    pricingFunction.itemCustomLineInit();
    pricingFunction.detailedReportInit();
    pricingFunction.itemCopyInit();
    pricingFunction.itemAddModificationInit();
    pricingFunction.viewItemInfoInit();
    pricingFunction.deleteLineItemInit();
  });
