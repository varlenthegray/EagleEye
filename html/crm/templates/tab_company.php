  ...
  <div class="row m-t-10">
    <div class="col-md-2">
      <div class="col-md-12 inner-box">
        <h3 class="inner-box-header m-b-10">Company Details</h3>
        ...
        <fieldset class="form-group">
          ...
          <input type="text" class="form-control" id="company_name" placeholder="Company Name" value="SMCM, Inc" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_website">Website</label>
          <input type="text" class="form-control" id="company_website" placeholder="Company Website" value="smcm.us" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_timezone">Timezone</label>
          <select class="form-control" id="company_timezone">
        ...
        <fieldset class="form-group">
          ...
          <input type="text" class="form-control" id="company_phone" placeholder="Company Phone Number" value="(828) 966-9000" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_owner">Owner</label>
          <input type="text" class="form-control" id="company_owner" placeholder="Company Owner" value="Robert Grieves" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_address">Address</label>
          <input type="text" class="form-control" id="company_address" placeholder="Company Address" value="206 Vista Blvd." />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_city">City</label>
          <input type="text" class="form-control" id="company_city" placeholder="Company City" value="Arden" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_state">State</label>
          <select class="form-control" id="company_state">
        ...
        <fieldset class="form-group">
          ...
          <input type="text" class="form-control" id="company_zip" placeholder="Company Zip Code" value="28704" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_email">Email address</label>
          <input type="email" class="form-control" id="company_email" placeholder="Company Email" value="orders@smcm.us" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_num_employees">Number of Employees</label>
          <input type="text" class="form-control" id="company_num_employees" placeholder="Company Number of Employees" value="3824" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_annual_rev">Annual Revenue</label>
          <input type="text" class="form-control" id="company_annual_rev" placeholder="Company Annual Revenue" value="$3,124,631.00" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_linkedin">LinkedIn</label>
          <input type="text" class="form-control" id="company_linkedin" placeholder="Company LinkedIn" value="https://digg.com/sit/amet/justo/morbi.html" />
        </fieldset>

        <fieldset class="form-group">
          <label for="company_facebook">Facebook</label>
          <input type="text" class="form-control" id="company_facebook" placeholder="Company Facebook" value="https://digg.com/sit/amet/justo/morbi.html" />
        </fieldset>
      </div>
      ...
      <div class="col-md-12 inner-box">
        ...
        <button type="button" class="btn btn-success waves-effect waves-light">Attach Contact</button>
      </div>

      <div class="col-md-12 inner-box">
        <h3 class="inner-box-header m-b-10">Attachments</h3>
      ...
      <div class="row" style="min-height:300px;">
        <div class="col-md-12">
          <ul class="nav nav-tabs" id="companySummary" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="profile-tab" data-toggle="tab" href="#dropdown2" role="tab" aria-controls="profile"><i class="fa fa-phone m-r-5"></i> Call</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"><i class="fa fa-flash m-r-5"></i> Create Task</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"><i class="fa fa-plus-circle m-r-5"></i> Add Project</a>
            </li>
          </ul>
          <div class="tab-content" id="companySummaryContent">
            <div role="tabpanel" class="tab-pane fade in active show" id="home" aria-labelledby="home-tab" style="border:1px solid #CCC;">
              <div id="new_note" style="width:100%;height:200px;"></div>
              ...
              <div class="new_note_actions">
                ...
                <div class="crm_contact_assc_list">
                  ...
                  <div class="crm_contact_association cursor-hand crm_assoc_add">
      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="nav nav-pills m-b-5 m-t-10" id="myTabalt" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link" id="profile-tab1" data-toggle="tab" href="#dropdown2-alt" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-comments-o m-r-5"></i> Calls</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="profile-tab1" data-toggle="tab" href="#profile1" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-flash m-r-5"></i> Tasks</a>
            </li>
          </ul>
