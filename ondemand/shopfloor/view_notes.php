...
$op_queue_qry = $dbconn->query("SELECT * FROM op_queue JOIN rooms ON op_queue.room_id = rooms.id JOIN operations ON op_queue.operation_id = operations.id WHERE op_queue.id = '{$queue_ID}'");
