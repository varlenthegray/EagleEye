    ...
    case "general":
        ...
        if($qry->num_rows > 0) {
            while($result = $qry->fetch_assoc()) {
                ...
                /** ADD ROOM TO SO */
                echo "<tr class='add_room' id='{$result['so_num']}' style='display:none;'><td colspan='8'><div style='display:none;'></div></td></tr>";
                /** END ADD ROOM TO SO */
                            ...
                            if($room_qry->num_rows > 0) {
                                while($room = $room_qry->fetch_assoc()) {
                                    ...
                                    echo "  <td class='nowrap' style='width:50px;'>
                                                <button class='btn waves-effect btn-primary edit_room' id='{$room['id']}'><i class='zmdi zmdi-edit'></i></button> <button class='btn waves-effect $attachment_code' id='show_attachments_room_{$room['id']}'><i class='zmdi zmdi-attachment-alt'></i></button> 
