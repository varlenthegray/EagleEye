...
if($_REQUEST['action'] === 'sent') {
    ...
    if((bool)$_REQUEST['search_toggle'] !== true) { // if we're not searching
        ...
        $error .= checkIt($email, "Email Account", 5);
    ...
    <form action="contact_management.php?action=sent" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <fieldset class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Email Address" id="email_address" name="email_address" tabindex="6" value="<?php echo $_REQUEST['alias']; ?>">
                        </fieldset>
                    </div>
                    ...
                    <div class="col-md-12" id="directions_group" style="display: none;">
                        <fieldset class="form-group">
                            <label for="directions" class="align-top">Directions <small class="text-muted">(Optional)</small></label>
                            <textarea id="directions" name="directions" placeholder="Directions to Location" rows="3" class="form-control"></textarea>
                        </fieldset>
                    </div>
        ...
        <div class="col-md-6">
            <div class="card-box matchmaker">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="tablesaw table m-b-0" style="font-size: 12px;" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap>
                            <thead>
                                <tr>
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="3"><strong>Type</strong></th>
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist"><strong>Name</strong></th>
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2"><strong>Company</strong></th>
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1"><strong>Phone</strong></th>
                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4"><strong>Billing Address</strong></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
